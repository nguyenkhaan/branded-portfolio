...
export default function HeroSection() {
    return (
        ...
        >
            <h2 className="uppercase font-medium text-center text-text-secondary font-syne tracking-wider text-base">
                Branded in White
            </h2>
            ...
            <h2 className="uppercase font-medium text-center text-text-secondary font-syne tracking-wider text-sm">
                Scroll to explore 
            </h2>
        </section>
    );
